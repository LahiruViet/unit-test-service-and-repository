...
public class StudentIntegrationTest {
    ...
    void testRegisterNewStudent() throws Exception {
        ...
        Student student = new Student(name, String.format("%s@lahiru.edu",
                StringUtils.trimAllWhitespace(name.trim().toLowerCase())), Gender.MALE);
    ...
    void testDeleteStudent() throws Exception {
        ...
        String email = String.format("%s@lahiru.edu",
